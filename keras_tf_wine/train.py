...
def train(run, model_name, data_path, epochs, batch_size, mlflow_custom_log):
    ...
    if mlflow_custom_log:
        ...
        mlflow_keras.log_model(model, "tensorflow-model", registered_model_name=model_name)
    else:
...
def main(experiment_name, data_path, model_name, epochs, batch_size, keras_autolog, tensorflow_autolog,
         mlflow_custom_log):
    import mlflow
    print("Options:")
